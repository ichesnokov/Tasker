...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{TASKER_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{TASKER_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
tasker_server.pl - Catalyst Testserver

=head1 SYNOPSIS

tasker_server.pl [options]
